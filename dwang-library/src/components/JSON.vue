...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          v-for="(hours, day) in bookstores.openingHours"
          :key="day"
        >
    ...
    <section class="lab-section">
      ...
      <p>Click an author below to highlight them:</p>
      <ul>
        <li
          ...
          :style="{
            opacity: author.birthYear > threshold ? 1 : 0.4,
            fontStyle: author.birthYear > threshold ? 'normal' : 'italic'
          }"
